var popWin = {
    ...
    showWin: function (a, b, c, d) {
        ...
        (h +=
            ...
            (h +=
                '<div id="maskTitle" style="height:35px; line-height: 35px; font-size: 14px; font-weight:bold; color: #797979; padding-left: 10px; background: url(./images/hbbg.webp); border-bottom: 1px solid #d1d1d1; position: relative;">'),
            (h += "" + c),
            (h +=
                '<div id="popWinClose" style="width: 15px; height:15px; cursor: pointer; position: absolute; top:10px; right: 9px; background: url(./assets/images/closehdtipper.webp)"></div>'),
            (h += "</div>"),
            (h +=
                '<iframe width="' +
                a +
    ...
    mouseClose: function () {
        $("#popWinClose").on("mouseenter", function () {
            $(this).css(
                "background-image",
                "url(./assets/images/closehdtipper.webp)"
            );
        }),
